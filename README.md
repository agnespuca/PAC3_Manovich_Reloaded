...
Assaig PAC3 - Manovich Reloaded: dos casos d’hibridació contemporània
...
- [Cas 1: Refik Anadol – Machine Hallucinations (2019)](#cas-1-refik-anadol--machine-hallucinations-2019)
  - [Recursos multimèdia Cas 1](#recursos-multimedia-cas-1)
- [Cas 2: AI Dungeon – Narrativa generativa interactiva (2019 – present)](#cas-2-ai-dungeon--narrativa-generativa-interactiva-2019--present)
  - [Recursos multimèdia Cas 2](#recursos-multimedia-cas-2)
...
- **Enllaços:** 
  - [Refik Anadol – Web oficial](https://refikanadol.com/)
...
---
## Recursos multimèdia Cas 1

### Vídeos explicatius dels projectes

- Machine Hallucination – Project Overview  
  https://www.youtube.com/watch?v=x1EVhNM-uf4

- Machine Hallucination | Behind the Scenes  
  https://www.youtube.com/watch?v=1MJCohk3-04

- Artist Insight: Refik Anadol  
  https://www.youtube.com/watch?v=8et1aGdI0HU

- Refik Anadol – *Unsupervised* (MoMA)  
  https://www.youtube.com/watch?v=5Y384U-bOJo

---

### Galeries d’imatges d’art digital

- Web oficial – *Machine Hallucination: NYC*  
  https://refikanadol.com/works/machine-hallucination-nyc/

- ARTECHOUSE – Exposició immersiva  
  https://www.artechouse.com/program/machine-hallucination-nyc/
...
- Refik Anadol Studio – Projectes i experiments visuals  
  https://refikanadol.com/works/

- *Machine Hallucinations – Space : Metaverse* (Sotheby’s)  
  https://www.sothebys.com/en/digital-catalogues/machine-hallucinations-space-metaverse
...
- **Enllaços:** 
  ...
  - [Video explicatiu del funcionament de AI Dungeon](https://www.youtube.com/watch?v=uNT0MTYW1MIttps://www.theverge.com/2020/1/15/21065237/ai-dungeon-text-adventure-gpt-3-novel-game)

### Descripció analítica
AI Dungeon és un joc narratiu en què els continguts textuals són generats dinàmicament per un model d’IA. L’usuari interactua amb la història introduint decisions i accions, i el programari crea respostes narratives en temps real. Aquest exemple representa clarament una **hibridació de programari i cultura**, on el software esdevé de co-creador de la narrativa i el jugador és part integrant del procés creatiu.  

Segons la perspectiva de Manovich, el joc il·lustra la interacció entre **bases de dades i algoritmes**: el model d’IA actua com a base de dades lingüística i motor de generació, mentre que l’usuari funciona com a interfície interactiva que guia la producció. La narrativa és **procedural i infinita**, una extensió dels principis de programari que Manovich descrivia en 2013, però aplicada a l’era de la intel·ligència artificial generativa.  

AI Dungeon també incorpora elements de **crowdsourcing**, on la comunitat comparteix escenaris, personatges i prompts, alimentant el contingut disponible i contribuint a la seva evolució constant. Això exemplifica com la cultura digital moderna es construeix de manera col·laborativa, més enllà de la creació individual.  

Finalment, AI Dungeon representa un nou format de publicació i entreteniment que Manovich només podia anticipar de manera teòrica: la intersecció entre software, narrativa, interactivitat i participació comunitària.  

---

## Recursos multimèdia Cas 2
...
- Web oficial – AI Dungeon  
  https://aidungeon.com/

- Galeria de captures – Steam  
  https://store.steampowered.com/app/518060/AI_Dungeon/

- Exemples de partides i captures de la comunitat  
...
- AI Dungeon – Plataforma interactiva  
  https://play.aidungeon.com/

- AI Dungeon – Steam  
  https://store.steampowered.com/app/518060/AI_Dungeon/

- Latitude (estudi desenvolupador)  
  https://latitude.io/
...
Gea, M. (2022). Herramientas y metodología de crowdsourcing para la participación y creación colectiva de conocimiento abierto. A J. Alberich & D. Sánchez-Mesa (Eds.), *Transmedialización y crowdsourcing en la cultura mediática contemporánea* (pp. 35–57). Editorial Universidad de Granada.  
