...
- **Enllaços:** 
  ...
  - [Article sobre AI Dungeon i IA generativa](https://www.theverge.com/2020/1/15/21065237/ai-dungeon-text-adventure-gpt-3-novel-game)

### Descripció analítica
AI Dungeon és un joc narratiu en què els continguts textuals no estan preescrits, sinó que són generats dinàmicament per un model d’IA (GPT-3 i successors). L’usuari interactua amb la història introduint decisions i accions, i el programari crea respostes narratives en temps real. Aquest exemple representa clarament **hibridació de programari i cultura**, on el software esdevé co-creador de la narrativa i el jugador és part integrant del procés creatiu.  
...
AI Dungeon també incorpora elements de **crowdsourcing**: la comunitat comparteix escenaris, personatges i prompts, alimentant el contingut disponible i contribuint a la seva evolució constant. Això exemplifica com la cultura digital moderna es construeix de manera col·laborativa, més enllà de la creació individual.  
